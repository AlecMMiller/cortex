use iced::widget::{column, container, row, scrollable, span, text};
use iced_core::border;
use iced_core::font::{self, Font};
use iced_core::padding;
use iced_core::theme;
use iced_core::{self, color, Color, Element, Length, Padding, Pixels, Theme};

use std::cell::{Cell, RefCell};
use std::rc::Rc;
pub use url::Url;

pub use iced_core::text::Highlight;

use crate::widgets::helper::rich_text;
            ...
            {
                {
                    ...
                    highlighter = Some(Highlighter::new(&iced_highlighter::Settings {
...
pub trait Catalog:
    container::Catalog + scrollable::Catalog + iced_core::widget::text::Catalog
{
